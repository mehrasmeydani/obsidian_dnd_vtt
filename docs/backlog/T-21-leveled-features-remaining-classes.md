...
## Acceptance criteria
- [x] All 12 remaining 2014 classes (+ their SRD subclasses) get leveled
      feature data in the T-19 shape, from SRD 5.1 text.
- [x] Classes with mechanical effects get them applied at assembly where
      ...
      are text-only).
- [x] Caster classes: spell slots/cantrips-known tables are **out of
      scope** here (T-15 spell selection); feature text may reference
      them.
- [x] Data-integrity tests extended: every class has features beyond
