...
| [T-17](T-17-2024-edition-content.md) | 2024 (5.5e) edition content | P2 | M | 1–2 | — | needs-check |
...
| [T-44](T-44-fold-depth-precedence.md) | Content fold: deeper data wins over staged SRD stubs | P1 | M | 2 | T-17, T-43 | needs-check |
| [T-45](T-45-class-options-collapsible.md) | Class options step: collapsible sections | P3 | S | 1 | T-32 | todo |
